...
public interface PersonnelManagementMapper extends BaseMapper<PersonnelManagement> {
    ...
    void add(String name,String establishment,Integer actualNumber,Integer availableNumber,Float attendanceRate,
             Integer shouldArrive,Integer actualArrive);
    void del(Integer id);
    void change(Integer id,String name,String establishment,Integer actualNumber,Integer availableNumber,
